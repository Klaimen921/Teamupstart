                        ...
                        <form id="myForm" method="post"
                            ...
                            <div class="d-flex gap-24">
                                <div class="field-wrapper flex-1 d-flex flex-column gap-4">
                                    ...
                                    <select class="border-grey" name="schedule" id="">
                                        <option value="all" <?= isset($usersData['schedule']) && $usersData['schedule'] == 'all' ? 'selected' : '' ?>>All
                                        </option>
                                        <option value="remote" <?= isset($usersData['schedule']) && $usersData['schedule'] == 'remote' ? 'selected' : '' ?>>
                                            Remote</option>
                                        <option value="night" <?= isset($usersData['schedule']) && $usersData['schedule'] == 'night' ? 'selected' : '' ?>>Night
                                        </option>
                                        <option value="day" <?= isset($usersData['schedule']) && $usersData['schedule'] == 'day' ? 'selected' : '' ?>>Day
                                        </option>
                                    </select>
                                </div>
                                <div class="field-wrapper flex-1 d-flex flex-column gap-4">
                                    ...
                                    <select class="border-grey" name="age_user" id="">
                                        ...
                                        <option value="> 20" <?= isset($usersData['age_user']) && $usersData['age_user'] == '> 20' ? 'selected' : '' ?>> > 20
                                        </option>
                                        <option value="20 - 30" <?= isset($usersData['age_user']) && $usersData['age_user'] == '20 - 30' ? 'selected' : '' ?>>
                                            20 - 30</option>
                                        <option value="30 - 40" <?= isset($usersData['age_user']) && $usersData['age_user'] == '30 - 40' ? 'selected' : '' ?>>
                                            30 - 40</option>
                                        <option value="40 >" <?= isset($usersData['age_user']) && $usersData['age_user'] == '40 >' ? 'selected' : '' ?>>40 >
                                        </option>
                                    </select>
                                </div>
                                <div class="field-wrapper flex-1 d-flex flex-column gap-4">
                                ...
                                <div class="field-wrapper flex-1 d-flex flex-column gap-4">
                                    ...
                                    <select class="border-grey" name="experience" id="">
                                        <option value="> 1" <?= isset($usersData['experience']) && $usersData['experience'] == '> 1' ? 'selected' : '' ?>> > 1</option>
                                        <option value="1" <?= isset($usersData['experience']) && $usersData['experience'] == '1' ? 'selected' : '' ?>>1</option>
                                        <option value="2" <?= isset($usersData['experience']) &&  $usersData['experience'] == '2' ? 'selected' : '' ?>>2</option>
                                        <option value="3" <?= isset($usersData['experience']) && $usersData['experience'] == '3' ? 'selected' : '' ?>>3</option>
                                        <option value="4+" <?= isset($usersData['experience']) && $usersData['experience'] == '4+' ? 'selected' : '' ?>>4+</option>
                                    </select>
                                </div>
                                <div class="field-wrapper flex-1 d-flex flex-column gap-4">
                            ...
                            <div class="user-bio d-flex flex-column gap-16">
                                ...
                                <textarea class="body-m-regular text-primary border-grey" placeholder="bio"
                                    ...
                                    rows="10"><?= isset($usersData['description']) && $usersData['description'] ?></textarea>
                            </div>
